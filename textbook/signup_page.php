...
<body class="jumbotron">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="logout.php">Already Registered? Sign In</a></li>
                </ul>
            </div><!--.nav-collapse -->
        </div>
    </nav>
    ...
    <div class="text-center form-signin" id="center" >
        <form action="signup.php" class="form_design" method="post">
            ...
            <h2 style="margin-left:2%;">SIGN UP</h2><br/>
            ...
            <input type="submit" value="Sign Up" class="btn" id="dark">
